<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ProductActionPage.aspx.cs" Inherits="RazorpaySampleApp.WebForm11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid shadow" style="margin-top: 100px">
        <div class="row">
            <div class="col">
                        ...
                        <asp:Repeater ID="RptrProducts" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td><%#Math.Round(Convert.ToDecimal(Eval("productprice")),0)%></td>
                                    <td><%#Eval("productdiscount")%></td>
                                     <td><%#Eval("isfestiveoffer").ToString()=="1"?"Limited":Eval("isfestiveoffer").ToString()=="2"?"Festival Offer":"No Offer"%></td>
                                    <td>
                                        <center>
                                    ...
                                    <td><%#Eval("isAproved").ToString()=="1"?"Approved":"Disaproved"%></td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="LnkDeactivate" OnClientClick="return AreYouSure1(this);" OnClick="LnkDeactivate_Click" CssClass="btn btn-dark" runat="server">Deactivate</asp:LinkButton>
                                    </td>
                                    <td>
                                        <asp:LinkButton ID="LnkOffer" OnClick="LnkOffer_Click" CssClass="btn btn-dark" runat="server">Offer</asp:LinkButton></td>
                                    <td>
                                        <asp:LinkButton ID="LnkDelete" OnClientClick="return AreYouSure(this);" Visible="false" OnClick="LnkDelete_Click" CssClass="btn btn-dark" runat="server">Delete</asp:LinkButton>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
      ...
      <div class="modal-body">
          <div class="d-flex">
              ...
              <center>
                  ...
                  <asp:RadioButton ID="RdoLimitedOffer" Text="Limited Time Offer" Style="margin-right: 10px" GroupName="Offer" CssClass="fw-bold" runat="server" />
                  <asp:RadioButton ID="RdoNoOffer" Text="No Offer" GroupName="Offer" CssClass="fw-bold" runat="server" />
              </center>

          </div>
          <div class="mt-3">
              <center>
                   <asp:LinkButton ID="Lnkoffer" OnClick="Lnkoffer_Click1" CssClass="btn btn-dark" runat="server">Update Offer</asp:LinkButton>
              </center>
